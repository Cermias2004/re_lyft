                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildFaqTile(
                      ...
                      answer:
                          "Tap 'Where To' on the home screen, enter your destination, select a ride type, and tap Select to confirm.",
                    ),
                    const SizedBox(height: 12),
                    _buildFaqTile(
                      question: 'How do I add a payment method?',
                      answer:
                          "Go to Account > Payment and tap 'Add payment method' to enter your card details.",
                    ),
                    const SizedBox(height: 12),
                    _buildFaqTile(
                      question: 'How do I contact my driver?',
                      answer:
                          "Once your ride is confirmed, you can call or message your driver directly from the ride screen.",
                    ),
                    const SizedBox(height: 12),
                    _buildFaqTile(
                      question: 'How do I cancel a ride?',
                      answer:
                          "Tap on your active ride and select 'Cancel Ride'. Cancellation fees may apply.",
                    ),
