                    ...
                    children: [
                      ...
                      Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: _firstFocused ? Color(0xFF6B48FF) : Colors.grey[700]!,
                              ...
                              Row(
                                children: [
                                  ...
                                  if (_firstController.text.isNotEmpty)
                                    GestureDetector(
                                      onTap: () => setState(() => _firstController.clear()),
                                      child: Container(
                      ...
                      Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.circular(12),
                            border: Border.all(
                              color: _lastFocused ? Color(0xFF6B48FF) : Colors.grey[700]!,
                              ...
                              Row(
                                children: [
                                  ...
                                  if (_lastController.text.isNotEmpty)
                                    GestureDetector(
                                      onTap: () => setState(() => _lastController.clear()),
                                      child: Container(
                                        padding: EdgeInsets.all(4),
                                        decoration: BoxDecoration(
                                          color: Colors.grey[600],
